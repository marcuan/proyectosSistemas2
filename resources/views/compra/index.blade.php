        ...
        <table class="table">
            ...
            @foreach($compra as $compra)
                <tbody>
                    ...
                    <td>{!!link_to_route('compra.show', $title = 'Ver Detalles', $parameters = $compra->id, $attributes = ['class'=>'btn btn-primary']);!!}</td>
                    <td>{!!link_to_route('compra.edit', $title = 'Editar', $parameters = $compra->id, $attributes = ['class'=>'btn btn-primary']);!!}</td>
				 <td>{!!link_to_route('compra.edit', $title = 'VerDetalle', $parameters = $compra->id, $attributes = ['class'=>'btn btn-primary']);!!}</td>
                </tbody>
            @endforeach
        </table>
    </div>
