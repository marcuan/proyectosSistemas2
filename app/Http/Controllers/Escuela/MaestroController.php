...
class MaestroController extends Controller
{
	...
	{
		$this->authorize('listar', new Maestro());
	...
	{
		$this->authorize('crear', new Maestro());
	...
	{
		$this->authorize('ver', new Maestro());
	...
	{
		$this->authorize('editar', new Maestro());
	...
	{
		$this->authorize('inhabilitar', new Maestro());
