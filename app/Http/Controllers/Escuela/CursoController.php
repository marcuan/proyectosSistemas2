...
class CursoController extends Controller
{
	...
	{
		$this->authorize('listar', new Curso());
	...
	{
		$this->authorize('crear', new Curso());
	...
	{
		$this->authorize('editar', new Curso());
	...
	{
		$this->authorize('inhabilitar', new Curso());
